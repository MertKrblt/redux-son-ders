...
const Content = () => {
  ...
  return (
    <Container className="mt-5 text-center">
      ...
      <h4>
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nobis, eligendi assumenda ab ad neque, quaerat odit non blanditiis porro iusto culpa sapiente dignissimos asperiores! Id quisquam
